...
PACKAGE_DIR = os.path.join(ROOT, "src/{{ cookiecutter.package_name }}")
...
extlinks = {
    ...
    'pull': ('https://github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.repo_name }}/pull/%s', 'PR #'),
}
html_theme_options = {
...
latex_documents = [
    (master_doc, '{{ cookiecutter.project_name }}.tex', '{{ cookiecutter.project_name }} Documentation',
     '{{ cookiecutter.author }} \\textless{}{{ cookiecutter.email }}\\textgreater{}', 'manual'),
]
